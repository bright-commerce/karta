...
export default function ProductDetailsPage() {
  ...
  if (!product) {
    return <div className="container" style={{ padding: '4rem 1rem', minHeight: '60vh', textAlign: 'center' }}>Product not found.</div>;
  }
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
        ...
        <div>
          <div style={{ width: '100%', aspectRatio: '16/10', background: 'var(--muted)', borderRadius: '1rem', overflow: 'hidden', marginBottom: '1rem' }}>
            <img src={product.images[selectedImage]} alt={product.title} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
