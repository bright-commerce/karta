          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <th className="p-4 font-medium text-sm text-gray-500">Product</th>
                <th className="p-4 font-medium text-sm text-gray-500">Category</th>
                <th className="p-4 font-medium text-sm text-gray-500">Price</th>
                ...
                <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                  <td className="p-4 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 truncate w-48">{product.id}</p>
                    </div>
                  </td>
